<nav class="modulos">
    <div class="modulo verde">
        ...
        <ul>
            <li>
                <a href="exercicio.php?dir=pratica&file=pratica_teste">
                    PRATICAS/TETES
                </a>
            </li> 
        </ul>
    ...
    <div class="modulo vermelho">
        ...
        <ul>
            <li>
                <a href="exercicio.php?dir=sesssao&file=basico_sessao">
                    Sessão
                </a>
            </li> 
            <li>
                <a href="exercicio.php?dir=sesssao&file=gerenciando_sessao">
                    Gerenciando Sessão
                </a>
            </li> 
        </ul>
    ...
    <div class="modulo roxo-escuro">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=includes&file=riquere_return">
                    Riquire & Return
                </a>
            </li> 
            <li>
    ...
    <div class="modulo azul-escuro">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=classes_objetos&file=interfece">
                    Interfece 
                </a>
            </li> 
            <li>
            ...
            <li>
                <a href="exercicio.php?dir=classes_objetos&file=magic_mathods">
                    Métodos Mágicos 
                </a>
            </li> 
            <li>
    ...
    <div class="modulo vermelho-escuro">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=funcoes&file=closure_callble">
                    Closure & Callble
                </a>
            </li> 
            <li>
    ...
    <div class="modulo laranja">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=array&file=desadio_sortei">
                    Desafio Sorteio
                </a>
            </li> 
            <li>
    ...
    <div class="modulo roxo">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=controle&file=operadores_relacional">
    ...
    <div class="modulo azul">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=variaveis&file=interpolaçao">
                    Interpolação
                </a>
            </li>
            <li>
