...
$dateFixa = new DateTime('1975-01-25 15:30:50');
echo strftime($formatoDataHora, $dateFixa->getTimestamp()) . '<br>';
...
/* 
    Fazendo comparações com objetos de DateTime()
*/
...
$agora = new DateTime(null,$meuTimezone);
